...
public class ProxyUtils {
    ...
    private static final Set<String> SHOULD_NOT_PROXY_HOP_BY_HOP_HEADERS = ImmutableSet.of(
        ...
        HttpHeaderNames.TE.toString().toLowerCase(Locale.US), HttpHeaderNames.TRAILER.toString().toLowerCase(Locale.US),
    ...
    public static void addVia(HttpMessage httpMessage, String alias) {
        String newViaHeader = new StringBuilder().append(httpMessage.protocolVersion().majorVersion()).append('.')
            .append(httpMessage.protocolVersion().minorVersion()).append(' ').append(alias).toString();
    ...
    public static void main(String[] args) {
        ...
        String url = "http://sh.sina.com.cn/news/m/2018-05-30/detail-ihcffhsv3736948.shtml";
